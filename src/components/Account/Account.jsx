            ...
            {connectors.map(({ title, icon, connectorId }, key) => (
              <div
                ...
                onClick={async () => {
                  ...
                  try {
                    let options  = { provider: connectorId, signingMessage: "PentSwap Authentication" };
                    if(key === 1) {
                      options = { provider: connectorId, signingMessage: "PentSwap Authentication",  chainId: 56 };
                          ...
                          await window.ethereum.request({
                            ...
                            if (switchError.code === 4902) {
                                try {
                                  ...
                                  alert("Install BSC Network to use this app");
                                  setIsAuthModalVisible(false);
                                  return;
                                }
                            } else if (switchError.code === 4001) {
                              alert("Switch to BSC Network to use this app");
                              setIsAuthModalVisible(false);
                              return;
                            } 
                    ...
                    setIsAuthModalVisible(false);
                    //window.web3Js = new Web3(Moralis.provider)
